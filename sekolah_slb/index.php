 ...
 <div id="home" class="slider-area">
    <div class="bend niceties preview-2">
      <div id="ensign-nivoslider" class="slides">
        <img src="assets_wali/img/slider/testing.jpeg" alt="" title="#slider-direction-1" />
        <img src="assets_wali/img/slider/gambar.jpg" alt="" title="#slider-direction-2" />
        <img src="assets_wali/img/slider/gambar.jpg" alt="" title="#slider-direction-3" />
      </div>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-left">
              <div class="single-well">
                <a href="#">
                  <img src="assets/img/profile_sekolah/<?= $data_profile['gambar_sekolah']?>" alt="" style = "width : 500px">
                </a>
              </div>
            </div>
          </div>
                    ...
                    <center>
                        <div class="about-move">
                            ...
                            <div class="single-services">
                                ...
                                <img src="assets/img/alur/<?= $row['gambar_alur']?>" alt="" style = "height: 113px; width: 142px;">
                                </a>
                                <h4><?= $row['judul']?></h4>
                                <p>
                                <?= $row['deskripsi']?>
            ...
            while($row = mysqli_fetch_assoc($galeri)) { ?>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 design development">
                    <div class="single-awesome-project">
                        ...
                        <a href="#"><img src="assets/img/galeri/<?= $row['galeri_gambar']?>" alt="" style ="width:500px; height :300px;"/></a>
                        <div class="add-actions text-center">
                            <div class="project-dec">
                            <a class="venobox" data-gall="myGallery" href="assets/img/galeri/<?= $row['galeri_gambar']?>">
                            </a>
                            </div>
                        </div>
                        </div>
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="single-blog">
                  <div class="single-blog-img">
                    <a href="">
                      <img src="assets/img/informasi/<?= $row['gambar_informasi']?>" alt="" style = "width: 360px; height:300px;">
                    </a>
                  </div>
                  <div class="blog-meta">
                  ...
                  <span>
                    <a href="walimurid/detail_informasi.php?id=<?= $row['id_informasi']?>" class="ready-btn">Read more</a>
                  </span>
                </div>
              </div>
            <?php } ?>
  ...
  <div class="modal fade" id="myModal">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form action="proses_walimurid/quisioner/insert.php" method="post" enctype='multipart/form-data'>
